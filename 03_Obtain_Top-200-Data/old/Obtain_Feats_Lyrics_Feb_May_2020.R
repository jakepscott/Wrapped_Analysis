...
all_songs <- read_rds(here("03_Obtain_Top-200-Data/data/Feb13_to_May31_raw.rds")) %>% #Getting consistent names
  ...
  select(date, Song,Id, Artist,Playlist) 
...
saveRDS(Features,here("03_Obtain_Top-200-Data/data/Feb13_to_May31_Feats.rds"))


# Get Lyrics and Lyric Features --------------------------------------------------------------
#Raw features
Lyrics <- Lyric_Generation_Function(data)
saveRDS(Lyrics,here("03_Obtain_Top-200-Data/data_new/Feb13_to_May31_Lyrics.rds"))
...
saveRDS(Lyric_Features,here("03_Obtain_Top-200-Data/data_new/Feb13_to_May31_Lyric_Features.rds"))
...
saveRDS(Full_Data,here("03_Obtain_Top-200-Data/data/Feb13_to_May31_Feat_Lyrics_Data.rds"))
saveRDS(Full_Data,here("data/Feb13_to_May31_Feat_Lyrics_Data.rds"))
